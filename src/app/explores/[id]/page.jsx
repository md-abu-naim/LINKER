    ...
    return (
        <div className='relative flex justify-between'>
            ...
            <div className='flex flex-col lg:flex-row justify-between'>
                ...
                <div className='flex items-center justify-between gap-3 h-[90vh]'>
                    <div className=' flex w-full h-full'>
                        ...
                        <div className="absolute md:static -right-4 bottom-6 flex flex-col items-center justify-end gap-5 mb-4 py-2 md:py-1 z-50">
                            ...
                            <Link href="?comments=true" className="flex items-center gap-2 px-6 py-1 text-xl text-gray-400 rounded-lg hover:bg-gray-700 hover:text-cyan-400 transition-colors duration-200 ease-in-out">
                                <FaComment />
                                <span>24</span>
                            </Link>
                            <button className="flex items-center gap-2 px-6 py-1 text-xl text-gray-400 rounded-lg hover:bg-gray-700 hover:text-cyan-400 transition-colors duration-200 ease-in-out">
                ...
                {
                    showSidebar && (
                        <div className='lg:w-1/3 w-full flex flex-col bg-gray-950 border-l border-gray-800 lg:max-h-[90vh] lg:overflow-hidden hover:overflow-y-auto'>

    ...
    return (
        <div className="space-y-4 hidden peer-checked:block p-6 rounded-2xl border border-gray-800 shadow-[0_0_25px_rgba(0,255,255,0.03)] mt-3">
            <div className="overflow-hidden">
                <Image className="w-full max-h-56 md:max-h-80 object-cover rounded-xl shadow-lg" src={'https://i.postimg.cc/MTvqpvT7/cover.jpg'} width={800} height={400} alt="Cover" />
            </div>
            <div className="flex items-center justify-center">
                <input type="file" id="coverInput" className="hidden" />

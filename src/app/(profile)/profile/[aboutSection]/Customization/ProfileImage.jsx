...
const ProfileImage = ({ user }) => {
    ...
    return (
        <div className="space-y-4 hidden peer-checked:block p-6 rounded-2xl border border-gray-800 shadow-[0_0_25px_rgba(0,255,255,0.03)] mt-3">
            ...
            {
                profileUrl && <button onClick={() => hanldeUpdateProfile(user)} className="w-full bg-linear-to-r from-cyan-500 to-blue-600 hover:from-cyan-400 hover:to-blue-500 py-3 rounded-2xl font-semibold text-lg transition-all duration-300 shadow-lg shadow-cyan-900/20">
                    Change Profile
                </button>
            }
        </div>

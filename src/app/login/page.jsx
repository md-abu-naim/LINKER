        ...
        <div className='flex items-center justify-between'>
            ...
            <div className=''>
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4'>
                    {/* Accounts */}
                    <div className='relative bg-gray-950 p-4 rounded-lg shadow-2xs cursor-pointer hover:scale-95 transition-all'>
                        <span className='absolute top-1 left-1 font-extrabold bg-gray-700 hover:bg-gray-900 rounded-full p-0.5'><RxCross1 /></span>
                        <Image
                            className='w-14 h-20 md:w-full md:h-56 rounded-lg object-cover'
                    ...
                    {/* Add Account */}
                    <div className='bg-gray-950 p-4 rounded-lg shadow-2xs cursor-pointer hover:scale-95 transition-all'> 
                        <div className='flex items-center justify-center bg-gray-900 rounded-lg w-14 h-20 md:w-full md:h-56'>

                ...
                <div className="flex justify-between items-center px-3 sm:px-4 py-2">
                    ...
                    <div className="flex items-center justify-between gap-2 sm:gap-5">
                        <Link href='/notifications' title="Cart Items" className="relative">
                            <button className="text-xl md:text-3xl hover:text-cyan-400 transition-colors"><FaBell /></button>
                        ...
                        <Link href='/message' title="Cart Items" className="relative z-10">
                            <button className="text-xl md:text-3xl hover:text-cyan-400 transition-colors"><LuMessageCircleHeart /></button>

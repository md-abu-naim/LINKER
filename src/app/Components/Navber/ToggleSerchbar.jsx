...
const ToggleSerchbar = () => {
    ...
    return (
        <div className="">
            ...
            <div className="hidden md:flex items-center bg-gray-800 rounded-full px-3 py-2 ml-3">
                <svg
            ...
            <div onClick={() => setActive(!active)} className={`${active ? 'hidden' : 'block'} md:hidden bg-gray-800 rounded-full text-gray-400 p-2 w-8 h-8`}>
            ...
            <div className={`${active ? 'block absolute top-0 left-0' : 'hidden'} lg:hidden `}>
                <div className={` flex items-center bg-gray-800 rounded-full px-3 py-2 ml-3`}>
                    ...
                    <input
                        type="search"
                        placeholder="Search Linker"
                        className="bg-transparent z-50 outline-none text-sm px-2 w-fit focus:w-44 transition-all duration-300"
                    />
                </div>
